...
@section('content')
    ...
    <div class="container">
        ...
        <ul class="nav nav-tabs mb-3">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="{{ route('laporan.create-bencana') }}">Laporan Bencana</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('laporan.create-kriminal') }}">Laporan Kriminal</a>
            </li>
        </ul>
        ...
        <form method="POST" action="{{ route('laporan.store') }}" id="laporanForm" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="kategoriLaporan"
                    class="col-md-5 col-form-label text-md-left">{{ __('Kategori Bencana') }}</label>
