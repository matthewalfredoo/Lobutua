...
<div class="container">
    ...
    <ul class="nav nav-tabs mb-3">
        ...
        <li class="nav-item">
            <a class="nav-link active">Surat Keterangan Kematian</a>
        </li>
        <li class="nav-item">
    ...
    <form method="POST" action="{{ route('keterangan.store') }}" id="AdministrasiForm">
        <h4 class="text-center form-login-title">Surat Keterangan Kematian
        </h4>
        ...
        <p class="col-md-9 text-left" id="descForm">
            ...
            Keterangan Kematian dengan data sebagai berikut *
        </p>
        @csrf
        ...
        <div class="form-group">
            <label for="ttlAdministrasi"
                class="col-md-7 col-form-label text-md-left">{{ __('Tempat/Tgl.Meninggal') }}</label>

            <div class="col-md-6" id="ttlPosition">

                <input type="text" id="ttlAdministrasi"
                    class="form-control @error('data4') is-invalid @enderror" name="data4"
                    autocomplete="data4" style="width: 80px" value="{{ old('data4') }}">
                ...
                <input id="ttlAdministrasi" type="date"
                    class="form-control @error('ttlAdministrasi') is-invalid @enderror"
                    name="data5" autocomplete="data5"
                    style="width: 130px; margin-left: 2%" value="{{ old('data5') }}">
            ...
            <div class="col-md-2">
                <fieldset id="jenis_kelamin" style="display: flex; flex-wrap:wrap; justify-content: space-between">
                    <div class="form-check">
                        <div class="row">
                            <div class="col-md-12">
                                <input class="form-check-input @error('data6') is-invalid @enderror" type="radio"
                                    name="data6" id="pria_sp_ktp" value="Pria"
                                    {{ old('data6') == 'Pria' ? 'checked' : '' }}>
                                <label class="form-check-label mr-5" for="pria_sp_ktp">
                                    Pria
                                </label>

                                <input class="form-check-input @error('data6') is-invalid @enderror" type="radio"
                                    name="data6" id="wanita_sp_ktp" value="Wanita"
                                    {{ old('data6') == 'Wanita' ? 'checked' : '' }}>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="agamaAdministrasi" type="text"
                    ...
                    autocomplete="data7" value="{{ old('data7') }}">
