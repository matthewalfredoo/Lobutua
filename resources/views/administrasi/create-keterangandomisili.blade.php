...
@section('content')
    ...
    <div class="container">
        ...
        <ul class="nav nav-tabs mb-3">
            <li class="nav-item">
                <a class="nav-link active">Surat Keterangan Domisili</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('keterangan.kematian') }}">Surat Keterangan Kematian</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('keterangan.kurang-mampu') }}">Surat Keterangan Kurang Mampu</a>
            </li>
        </ul>

        <form method="POST" action="{{ route('keterangan.store') }}" id="AdministrasiForm">
            <h4 class="text-center form-login-title">Surat Keterangan Domisili
            </h4>
            ...
            <p class="col-md-9 text-left" id="descForm">
                ...
                Keterangan Domisili dengan data sebagai berikut *
            </p>
            @csrf
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="nameAdministrasi" type="text" class="form-control @error('data1') is-invalid @enderror"
                        name="data1" autocomplete="data1" autofocus value="{{ old('data1') }}">
                ...
                <div class="col-md-2">
                    <fieldset id="jenis_kelamin" style="display: flex; flex-wrap:wrap; justify-content: space-between">
                        <div class="form-check">
                            <div class="row">
                                <div class="col-md-12">
                                    <input class="form-check-input @error('data2') is-invalid @enderror" type="radio"
                                        name="data2" id="pria_sp_ktp" value="Pria"
                                        {{ old('data2') == 'Pria' ? 'checked' : '' }}>
                                    <label class="form-check-label mr-5" for="pria_sp_ktp">
                                        Pria
                                    </label>

                                    <input class="form-check-input @error('data2') is-invalid @enderror" type="radio"
                                        name="data2" id="wanita_sp_ktp" value="Wanita"
                                        {{ old('data2') == 'Wanita' ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <label for="nameAdministrasi" class="col-md-7 col-form-label text-md-left">{{ __('No. KTP/KK') }}</label>

                <div class="col-md-4">
                    <input id="nameAdministrasi" type="text" class="form-control @error('data5') is-invalid @enderror"
                        name="data5" autocomplete="data5" value="{{ old('data5') }}">
            ...
            <div class="form-group">
                <label for="SperkawinanAdministrasi"
                    class="col-md-7 col-form-label text-md-left">{{ __('Kewarganegaraan') }}</label>

                <div class="col-md-3">
                    <select id="SperkawinanAdministrasi" class="form-select form-select-sm @error('data6') is-invalid @enderror"
                        aria-label=".form-select-sm example" id="SperkawinanAdministrasi"
                        name="data6" value="{{ old('data6') }}" autocomplete="data6">
                        <option selected disabled>Pilih</option>
                        <option value="WNI" {{ old('data6') == "WNI" ? "selected" : "" }}>WNI</option>
                        <option value="WNA" {{ old('data6') == "WNA" ? "selected" : "" }}>WNA</option>
                    </select>
            ...
            <div class="form-group">
                <label for="nameAdministrasi" class="col-md-7 col-form-label text-md-left">{{ __('Agama') }}</label>

                <div class="col-md-4">
                    <input id="nameAdministrasi" type="text" class="form-control @error('data7') is-invalid @enderror"
                        name="data7" autocomplete="data7" value="{{ old('data7') }}">
            ...
            <div class="form-group">
                <label for="alamatSAdministrasi"
                    class="col-md-6 col-form-label text-md-left">{{ __('Alamat Asal') }}</label>

                <div class="col-md-5">
                    <textarea class="form-control @error('data8') is-invalid @enderror" id="alamatSAdministrasi" rows="4"
                        name="data8" autocomplete="data8">{{ old('data8') }}</textarea>
